...
class Lcd:
    ...
    def gen_image_bytes(self,image,format=cv2.COLOR_BGR2BGR565):
    ...
    def display(self,image,format=cv2.COLOR_BGR2BGR565):
        image_bytes = self.gen_image_bytes(image,format)
        h,w,c = image.shape
        #居中显示
